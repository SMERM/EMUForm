...
RSpec.describe Accounts::AccountsController, type: :controller do
  ...
  describe "whatever" do
    skip('The Accounts::AccountsController is to be done COMPLETELY!')
  end

# TODO: this is *ALL* to be refactored following devise
#
